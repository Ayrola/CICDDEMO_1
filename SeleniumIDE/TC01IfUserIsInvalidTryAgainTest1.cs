...
namespace Tests
{
    ...
    public class TC01IfUserIsInvalidTryAgainTest
    {
        ...
        public void SetUp()
        {
            ...
            //Runs Chrome without a visible UI (no browser window).
            options.AddArgument("headless");
            //Disables Chrome’s security sandbox.
            options.AddArgument("no-sandbox");
            //In containers (like Docker), the shared memory size is small and may crash the browser. This prevents that.
            options.AddArgument("disable-dev-shm-usage");
            //Not needed in headless mode, and disabling it avoids certain rendering or compatibility issues.
